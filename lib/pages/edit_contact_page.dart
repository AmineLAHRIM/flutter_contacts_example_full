...
class _EditContactPageState extends State<EditContactPage> with AfterLayoutMixin<EditContactPage> {
            ...
            onPressed: () async {
              await showDialog(
                ...
                builder: (_) => AlertDialog(
                  content: Text(prettyJson(_contact.toJson(withPhoto: false, withThumbnail: false))),
                ),
              );
            },
          ),
          IconButton(
            ...
            onPressed: () async {
              await showDialog(
                context: context,
                builder: (_) => AlertDialog(
                  content: Text(_contact.toVCard(withPhoto: false, includeDate: true)),
                ),
              );
            },
          ),
        ...
        _contact.photo == null
            ...
            : Align(
                ...
                child: PopupMenuButton(
                  itemBuilder: (context) => [PopupMenuItem(value: 'Delete', child: Text('Delete photo'))],
  ...
  Card _eventCard() => _fieldCard(
        ...
        () async {
          ...
          if (date != null) {
            _contact.events = _contact.events + [Event(year: date.year, month: date.month, day: date.day)];
          }
        },
        ...
        child: Row(
          ...
          children: [
            ...
            Checkbox(
              ...
              onChanged: (bool isStarred) => setState(() => _contact.isStarred = isStarred),
            ),
          ],
        ),
      );
